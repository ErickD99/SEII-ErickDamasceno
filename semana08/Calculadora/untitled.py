...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(362, 289)
        MainWindow.setMinimumSize(QSize(362, 289))
        MainWindow.setMaximumSize(QSize(362, 289))
        icon = QIcon()
        ...
        self.gridLayoutWidget.setGeometry(QRect(-1, 90, 361, 201))
        ...
        self.visor.setGeometry(QRect(-6, 2, 371, 91))
